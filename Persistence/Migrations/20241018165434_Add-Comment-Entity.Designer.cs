...
namespace Persistence.Migrations
{
    ...
    [Migration("20241018165434_Add-Comment-Entity")]
            ...
            modelBuilder.Entity("Domain.Categorys.CategoryType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 10, 18, 9, 54, 34, 263, DateTimeKind.Local).AddTicks(7528));
            ...
            modelBuilder.Entity("Domain.Posts.Post", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 18, 9, 54, 34, 264, DateTimeKind.Local).AddTicks(2942));
            ...
            modelBuilder.Entity("Domain.Posts.PostFavorite", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 18, 9, 54, 34, 264, DateTimeKind.Local).AddTicks(7717));
            ...
            modelBuilder.Entity("Domain.Posts.PostImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 18, 9, 54, 34, 265, DateTimeKind.Local).AddTicks(1248));
